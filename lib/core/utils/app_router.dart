    ...
    routes: [
      ...
      GoRoute(
        ...
        routes: [
          ...
          GoRoute(
            path: 'orders',
            builder: (_, __) => const BorrowerOrdersPage(),
          ),
        ],
      ),
      ...
      GoRoute(
        ...
        routes: [
          ...
          GoRoute(
            path: 'add-listing',
            builder: (_, __) => const AddListingPage(),
          ),
          GoRoute(
          ...
          GoRoute(
            path: 'schedule/:id',
            builder: (_, state) => ListingSchedulePage(
              listingId: state.pathParameters['id']!,
            ),
          ),
          GoRoute(
            ...
            builder: (_, state) => RatingBorrowerPage(
              ...
              borrowerName: state.uri.queryParameters['borrowerName'] ?? '',
            ),
          ),
        ],
      ),
