...
final appRouterProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: '/borrower',
        builder: (context, state) => const BorrowerHomePage(),
        routes: [
          GoRoute(
            path: 'listing/:id',
          ...
          GoRoute(
              path: 'orders', builder: (_, __) => const BorrowerOrdersPage()),
        ],
      ),
      ...
      GoRoute(
        ...
        routes: [
          GoRoute(
              path: 'add-listing', builder: (_, __) => const AddListingPage()),
          GoRoute(
          ...
          GoRoute(
              path: 'bookings', builder: (_, __) => const LenderBookingsPage()),
        ],
      ),
