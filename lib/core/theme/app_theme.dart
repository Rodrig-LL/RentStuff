...
class AppTheme {
  ...
  static ThemeData get darkTheme {
    return ThemeData.dark().copyWith(
      // Warna background utama yang lebih cerah dari hitam pekat (Slate Dark)
      scaffoldBackgroundColor: const Color(0xFF1E293B),
      // Warna kotak/card yang sedikit lebih terang dari background agar menonjol
      ...
      // Memaksa seluruh teks dasar di mode gelap menjadi warna putih/terang
